...
if st.button('Gerar Plano de Corrida'):
    ...
    def gerar_plano(dias_disponiveis, objetivo):
        treino_semana = []
        ...
        for semana in range(1, 5):
            ...
            treinos = [
                "*Intervalado*: Aquecimento: 10 min trote leve. 6x 400m em ritmo forte com descanso de 1 min.",
                "*Corrida leve*: 5 km em ritmo confortável.",
                "*Ritmado*: 4 km em ritmo constante (70% do máximo).",
    ...
    plano_final = gerar_plano(dias_disponiveis, objetivo)
